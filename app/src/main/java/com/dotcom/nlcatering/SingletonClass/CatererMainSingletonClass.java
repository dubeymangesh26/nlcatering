...
public class CatererMainSingletonClass {

    private boolean check;

    private static CatererMainSingletonClass ourInstance = new CatererMainSingletonClass();



    public static CatererMainSingletonClass getInstance() {
        return ourInstance;
    }

    public static CatererMainSingletonClass clear() {
        return ourInstance = new CatererMainSingletonClass();
    }
    ...
    private CatererMainSingletonClass() {
    }
