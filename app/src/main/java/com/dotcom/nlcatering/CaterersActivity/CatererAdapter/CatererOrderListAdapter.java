...
public class CatererOrderListAdapter extends RecyclerView.Adapter<CatererOrderListAdapter.ViewHolder> {

    Context context;
    List<CatererOrderListResponse.ResponseBean> list;

    public CatererOrderListAdapter(Context context, List<CatererOrderListResponse.ResponseBean> responseBeanList) {
        this.context = context;
        this.list = responseBeanList;
    }

    @Override
    public CatererOrderListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view;
        view = LayoutInflater.from(context).inflate(R.layout.foodtype, parent, false);
        return new CatererOrderListAdapter.ViewHolder(view);

    }

    @Override
    public void onBindViewHolder(CatererOrderListAdapter.ViewHolder holder, final int position) {
        ...
        holder.foodmenuLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setContentView(R.layout.caterer_order_dialog);
               ...
               // set the custom dialog components - text, image and button
                ...
                text.setText(list.get(position).getCust_Name());
